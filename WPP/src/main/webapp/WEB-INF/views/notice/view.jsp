...
<script type="text/javascript">
	...
	function listReply() {
		$.ajax({
			type : "get",
			url : "${path}/noticereply/list.do?bnum=${dto.bnum}",
	...
	<div class="boardpadding">
		...
		<table border="1" width="73%"  style= "background-color: white">
			...
			<td>
				...
				<button type="button" class="btn btn-default" onClick="location.href='/noticeboard/list'">목록</button>		
	</div>	
		<br><br>
		<div class="boardpadding">
			<form name="form2" method="post" action="/noticereply/insert.do" method="${method}">
				<div style="width: 15%;">
					<br>
